"""
Django settings for college__system project.
...
ROOT_URLCONF = 'Smart_College_Portal.urls'
...
WSGI_APPLICATION = 'Smart_College_Portal.wsgi.application'
...
# For Heroku deployment (using dj_database_url)
# DATABASES = {
